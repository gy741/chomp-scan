...
function install_kali() {
		...
		sudo apt-get update;
	 	sudo apt-get install git wget curl nmap masscan whatweb sublist3r gobuster nikto wafw00f chromium openssl libnet-ssleay-perl p7zip-full build-essential python-pip python3-pip unzip graphviz graphviz-dev libgraphviz-dev graphviz-dev pkg-config -y;
		install_pip;
		install_dnscan;
		install_bfac;
		install_massdns;
...
function install_debian() {
		...
		sudo apt-get update;
		sudo apt-get install graphviz graphviz-dev libgraphviz-dev graphviz-dev pkg-config git wget curl nmap masscan whatweb chromium openssl libnet-ssleay-perl p7zip-full build-essential python-pip python3-pip unzip -y;
		install_pip;
...
function install_aquatone() {
		...
		wget https://github.com/michenriksen/aquatone/releases/download/v1.7.0-beta/aquatone_linux_amd64_1.7.0-beta.zip -O "$TOOLS"/aquatone.zip;
...
function install_amass() {
		...
		echo -e "$GREEN""Installing amass 3.1.10 from Github.""$NC";
		wget https://github.com/OWASP/Amass/releases/download/v3.1.10/amass_v3.1.10_linux_amd64.zip -O "$TOOLS"/amass.zip;
		unzip -o "$TOOLS"/amass.zip -d "$TOOLS";
		mv "$TOOLS"/amass_v3.1.10_linux_amd64 "$TOOLS"/amass;
		rm "$TOOLS"/amass.zip;
}
...
wget -O ~/chomp-scan/wordlists/all.txt https://gist.github.com/jhaddix/86a06c5dc309d08580a018c66354a056/raw/96f4e51d96b2203f19f6381c8c545b278eaa0837/all.txt
wget -O ~/chomp-scan/resolvers3.txt https://public-dns.info/nameservers.txt
