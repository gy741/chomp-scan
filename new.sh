...
apt-get update && apt-get install sublist3r gobuster unzip make gcc g++ wget curl nmap masscan nikto whatweb wafw00f chromium-browser python-pip python3-pip p7zip-full -y;
